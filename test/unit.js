...
describe("State", () => {
    let store;
    beforeEach(async () => {
        store = new index_1.Store(0, RedisParams);
    ...
    it("Should increment concurrent", async () => {
        let store2 = new index_1.Store(0, RedisParams);
        let store3 = new index_1.Store(0, RedisParams);
    ...
    it("Should increment concurrent expire", async () => {
        let store2 = new index_1.Store(1, RedisParams);
        let store3 = new index_1.Store(1, RedisParams);
        await store.reset(1);
        await Promise.all([store2.initialize(), store3.initialize()]);
        await Promise.all([
