...
describe("State", () => {
    ...
    it("Should increment concurrent", async () => {
        ...
        let store2 = new Store( RedisParams);
        let store3 = new Store( RedisParams);
    ...
    it("Should increment concurrent expire", async () => {
        ...
        let store2 = new Store({...RedisParams,...{initial:1}});
        let store3 = new Store({...RedisParams,...{initial:1}});
